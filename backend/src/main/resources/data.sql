...
(3,  'Estudio moderno Malasaña',          'Estudio completamente reformado con cocina integrada y baño en suite. Ideal para profesional joven. A 5 min del metro Tribunal.',                                              620.0, 'Todos los gastos incluidos',     'Madrid Malasaña',         'ACTIVE', 1),
...
(9,  'Estudio Triana',                    'Encantador estudio en el clásico barrio de Triana. Cocina americana, baño reformado y mucha luz natural. Muy tranquilo a pesar de estar bien ubicado.',                       520.0, 'Gastos incluidos excepto luz',  'Sevilla Triana',          'ACTIVE', 3),
...
(11, 'Loft industrial Bilbao',            'Espectacular loft de diseño industrial reformado. Techos altos de 4m, ventanales enormes y mobiliario de diseño. A 5 min del Museo Guggenheim.',                             700.0, 'Todo incluido',                 'Bilbao Abando',           'ACTIVE', 4),
