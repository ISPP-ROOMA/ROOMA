        ...
        {tab === 'pending' && (
          <>
            ...
            <div className="bg-teal-700 rounded-3xl p-4 sm:p-6 text-white flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
              <div>
                <p className="text-xs sm:text-sm text-teal-100 uppercase tracking-wide">
                  Total pendiente
                </p>
  ...
  return (
    ...
    >
      <div className="flex items-start sm:items-center gap-3 px-3.5 sm:px-4 py-3">
        <span
          className={`shrink-0 w-10 h-10 sm:w-11 sm:h-11 rounded-xl flex items-center justify-center text-base sm:text-lg ${icon.bg}`}
        >
          {icon.emoji}
        </span>
